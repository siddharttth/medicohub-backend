...
router.get('/search', optionalAuthenticate, readLimiter, validate(v.searchNotes, 'query'), ctrl.search);
...
router.get('/:id', optionalAuthenticate, readLimiter, ctrl.getOne);
...
router.post('/:id/rate', authenticate, generalLimiter, upload.none(), ctrl.rateNote);
